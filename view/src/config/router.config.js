    ...
    children: [
      {
        ...
        name: 'setting',
        // component: PageView,
        meta: { title: '设置', icon: 'setting', permission: ['dashboard'] },
      ...
      },
      {
        ...
        name: 'data',
        // component: PageView,
        meta: { title: '数据', icon: 'apple', permission: ['dashboard'] },
        component: () => import('@/views/setting/Setting')
      },
      {
        ...
        meta: { title: '个人设置', icon: 'setting', hideHeader: true, permission: ['user'] },
